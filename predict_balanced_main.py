#!/usr/bin/env python3
"""
Email Spam Detection - BalancedSpamNet Main Interface
Simplified prediction interface featuring BalancedSpamNet and other working models
"""
...
try:
    ...
    SVM_AVAILABLE = False
    print("[!] SVM predictor not available")
...
try:
    ...
    print("[!] CatBoost predictor not available")


class SimpleModelManager:
    """Simplified model manager focusing on BalancedSpamNet"""
    ...
    def scan_models(self):
        ...
        # Filter None values
        model_definitions = {k: v for k, v in model_definitions.items() if v is not None}
    ...
    def predict_text(self, text):
        ...
        try:
            ...
            if self.predict_method == "balanced_spam_net":
                ...
                # Return the full result for detailed display
                ...
                if isinstance(result, dict):
                    ...
                    # Tuple format (prediction, confidence)
